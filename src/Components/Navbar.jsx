...
const Navbar = ({ onClick }) => {
  return (
    <div className="navbar">
      <ul>
        <li>
          <NavbarItem onClick={onClick} title="Home" category="home">
            <svg
          ...
          <NavbarItem onClick={onClick} title="Last 30 Days" category="games">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              id="Layer_1"
              data-name="Layer 1"
        ...
        <li>
          <NavbarItem onClick={onClick} title="This Week" category="games">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              id="Outline"
              viewBox="0 0 24 24"
        ...
        <li>
          <NavbarItem onClick={onClick} title="Upcoming" category="games">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
              width="1.5rem"
